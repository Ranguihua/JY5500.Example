...
/// <summary>
/// JY5500 continuous pulse generation (digital trigger)
/// Author: JYTEK
...
/// 3. Press the Start button to start continuous pulse generation
///
/// </summary>
...
namespace Winform_CO_Continuous_Digital_Trigger
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            //Call the enumeration of CODigitalTriggerSource in the driver as a menu
            comboBox_triggerSource.Items.AddRange(Enum.GetNames(typeof(CODigitalTriggerSource)));
            comboBox_triggerSource.SelectedIndex = 0;

            //Call the enumeration of CODigitalTriggerEdge in the driver as a menu
            comboBox_triggerEdge.Items.AddRange(Enum.GetNames(typeof(CODigitalTriggerEdge)));
        ...
        private void button_Start_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                coTask.Trigger.Digital.Source = (CODigitalTriggerSource)Enum.Parse(typeof(CODigitalTriggerSource), comboBox_triggerSource.Text, true);
                coTask.Trigger.Digital.Edge = (CODigitalTriggerEdge)Enum.Parse(typeof(CODigitalTriggerEdge), comboBox_triggerEdge.Text, true);
