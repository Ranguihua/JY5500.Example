...
/// <summary>
/// JY5500 finite pulse generation (digital trigger)
/// Author: JYTEK
...
/// 3. Trigger parameter configuration
/// 4. Press the Start button to start finite pulse generation
///
/// </summary>
...
namespace Winform_CO_Finite_Digital_Trigger
{
    public partial class MainForm : Form
    {
        ...
        /// <summary>
        /// timer，Check if the ciTask is completed
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
