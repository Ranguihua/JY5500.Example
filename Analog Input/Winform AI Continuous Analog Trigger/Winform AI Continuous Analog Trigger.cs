...
/// <summary>
/// JY5500 single channel continuous data acquisition (analog trigger)
/// Author: JYTEK
...
/// 3. Input analog trigger parameters, including trigger mode, trigger condition and threshold
/// 4. Press the start button to start continuous data acquisition
/// </summary>
...
namespace Winform_AI_Continuous_Analog_Trigger
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            comboBox_TriggerSource.Items.AddRange(Enum.GetNames(typeof(AIAnalogTriggerSource)));
        ...
        private void button_start_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                aiTask.Trigger.Analog.Source = (AIAnalogTriggerSource)Enum.Parse(typeof(AIAnalogTriggerSource), comboBox_TriggerSource.Text, true);
