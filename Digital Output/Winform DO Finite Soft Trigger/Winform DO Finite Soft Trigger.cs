...
/// <summary>
/// JY5500 digital signal output (finite mode software trigger)
/// Author: JYTEK
...
namespace Winform_DO_Finite_Soft_Trigger
{
    public partial class MainForm : Form
    {
        ...
        private void time_FetchData_Tick(object sender, EventArgs e)
        {
            ...
            //Check DO finite point outputTask is over, if it is over Stop Task, otherwise Task is not completed, enable counter to continue query
