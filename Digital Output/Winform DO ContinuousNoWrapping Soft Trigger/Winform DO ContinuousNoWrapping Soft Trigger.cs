...
/// <summary>
/// JY5500 continuous non-surround mode digital output (software trigger)
/// Author: JYTEK
...
/// 2. Press the Start button and the Send Soft Trigger button to start a continuous digital output.
///
