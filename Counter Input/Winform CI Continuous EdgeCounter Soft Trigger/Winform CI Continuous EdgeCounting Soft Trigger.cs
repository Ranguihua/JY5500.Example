...
/// <summary>
/// JY5500 continuous mode edgeCounter (soft trigger)
/// Author: JYTEK
...
/// 3. Press the start button and the Send Soft Trigger button to start counting
/// Simple counting function:
/// In this mode, the Counter will record the number of pulses above the CTR_Source after the software start
/// </summary>
...
namespace Winform_CI_Continuous_EdgeCounter_Soft_Trigger
{
    public partial class MainForm : Form
    {
        ...
        //the Buffer of data read by ciTask
        ...
        private void button_stop_Click(object sender, EventArgs e)
        {
            ...
            //enable Parameter configuration button and start button
