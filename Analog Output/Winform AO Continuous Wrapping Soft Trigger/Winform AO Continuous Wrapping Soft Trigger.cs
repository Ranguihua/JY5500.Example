...
/// <summary>
/// JY5500 single channel continuous Wrapping output (software trigger)
/// Author: JYTEK
...
/// 3. Press the Start button and the Send Soft Trigger button to start continuous waveform output.
///
/// Wrapping output refers to the waveform that is repeatedly output and written during the running of the program, 
/// which cannot be updated in real time.
/// </summary>
